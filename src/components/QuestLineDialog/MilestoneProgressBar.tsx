...
export const MilestoneProgressBar = ({ totalQuests, completedQuests }: MilestoneProgressBarProps) => {
  ...
  return (
    <div className='milestone-progress'>
      ...
      >
        <div className='milestone-progress__fill' data-progress={progressPercent} />
      </div>
      <div className='milestone-progress__text'>
        <span className='milestone-progress__count' aria-hidden='true'>
